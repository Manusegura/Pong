...
while not game_over:
    ...
    vt = cronometro.tick(200)#variable para controlar la velocidad entre fotogramas
    #print(vt)
    ...
    '''if pelota.derecha >= raqueta2.izquierda and\
         ...
         pelota.arriba <= raqueta2.abajo and\
             pelota.izquieda <= raqueta2.derecha:
        pelota.vx *= -1

    if pelota.derecha >= raqueta1.izquierda and\
         pelota.abajo >= raqueta1.arriba and \
         pelota.arriba <= raqueta1.abajo and\
             pelota.izquieda <= raqueta1.derecha:
        pelota.vx *= -1'''
